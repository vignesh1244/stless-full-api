...
ImgageModel imgageModelFromJson(String str) => ImgageModel.fromJson(json.decode(str));
String imgageModelToJson(ImgageModel data) => json.encode(data.toJson());
class ImgageModel {
  ImgageModel({
      bool? success, 
      String? message, 
  ...
  ImgageModel.fromJson(dynamic json) {
  ...
  String? _message;
  List<Data>? _data;
ImgageModel copyWith({  bool? success,
  String? message,
  List<Data>? data,
}) => ImgageModel(  success: success ?? _success,
